...
public class RepeatingBackground : MonoBehaviour 
{
	...
	//public BoxCollider2D wallCollider;		//This stores a reference to the collider attached to the Ground.
	private float wallVerticalLength;		//A float to store the x-axis length of the collider2D attached to the Ground GameObject.
	...
	private void Awake ()
	{
        ...
        wallVerticalLength = GetComponent<SpriteRenderer>().bounds.size.y; ; 
	}
	...
	private void RepositionBackground()
	{
		...
		Vector2 wallOffSet = new Vector2(0, wallVerticalLength * 2f);
